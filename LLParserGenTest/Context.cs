...
namespace LLParserGenTest
{
	public class Context : IDisposable {
		...
		public void add(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_add, rd, rs, rt));
			emitNextLbl = null;
		}

		public void sub(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_sub, rd, rs, rt));
			emitNextLbl = null;
		}

		public void mul(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_mul, rd, rs, rt));
			emitNextLbl = null;
		}

		public void rem(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_rem, rd, rs, rt));
			emitNextLbl = null;
		}

		public void div(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_div, rd, rs, rt));
			emitNextLbl = null;
		}

		public void or_(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I__or, rd, rs, rt));
			emitNextLbl = null;
		}

		public void xor(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_xor, rd, rs, rt));
			emitNextLbl = null;
		}

		public void and(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_and, rd, rs, rt));
			emitNextLbl = null;
		}

		public void shl(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_shl, rd, rs, rt));
			emitNextLbl = null;
		}

		public void shr(string rd, ExprValue rs, ExprValue rt) {
			e();
			_ass.Add(new Op_rxx(this, emitNextLbl, OpCode.I_shr, rd, rs, rt));
			emitNextLbl = null;
		}

		public void jmp(string addr) {
			e();
			_ass.Add(new AssJ(this, emitNextLbl, OpCode.J_jmp, addr));
			emitNextLbl = null;
		}

		public void js(string rd, string addr) {
			e();
			_ass.Add(new AssJ(this, emitNextLbl, OpCode.J_js, rd, addr));
			emitNextLbl = null;
		}

		public void ret(ExprValue rt) {
			e();
			_ass.Add(new Op_Ret(this, emitNextLbl, rt));
			emitNextLbl = null;
		}

		public void beq(ExprValue rs, ExprValue rt, string addr) {
			e();
			_ass.Add(new Br_xx(this, emitNextLbl, OpCode.B_beq_rr, rs, rt, addr));
			emitNextLbl = null;
		}

		public void bne(ExprValue rs, ExprValue rt, string addr) {
			e();
			_ass.Add(new Br_xx(this, emitNextLbl, OpCode.B_bne_rr, rs, rt, addr));
			emitNextLbl = null;
		}

		public void blt(ExprValue rs, ExprValue rt, string addr) {
			e();
			_ass.Add(new Br_xx(this, emitNextLbl, OpCode.B_blt_rr, rs, rt, addr));
			emitNextLbl = null;
		}

		public void ble(ExprValue rs, ExprValue rt, string addr) {
			e();
			_ass.Add(new Br_xx(this, emitNextLbl, OpCode.B_ble_rr, rs, rt, addr));
			emitNextLbl = null;
		}

		public void bgt(ExprValue rs, ExprValue rt, string addr) {
			e();
			_ass.Add(new Br_xx(this, emitNextLbl, OpCode.B_bgt_rr, rs, rt, addr));
			emitNextLbl = null;
		}

		public void bge(ExprValue rs, ExprValue rt, string addr) {
			e();
			_ass.Add(new Br_xx(this, emitNextLbl, OpCode.B_bge_rr, rs, rt, addr));
			emitNextLbl = null;
		}

		public void ld(string rs, int c) {
			e();
			_ass.Add(new AssLdConst(this, emitNextLbl, rs, c));
			emitNextLbl = null;
		}
	...
	public class FunctionContex {
		...
		public void AddDefVar(string name, ExprType ty) { 
			if (_vars.ContainsKey(name) == true)
				throw new Exception(U.F("duplicated variable {0}", name));
			_vars[name] = new RegType(ctx.NewTmp(), ty);
		}
		...
		public void AddArgVar(string name, ExprType type) { 
			if (_vars.ContainsKey(name) == true)
				throw new Exception(U.F("duplicated variable {0}", name));
			_vars[name] = new RegType(U.F("r{0}", nvar++), type); 
		}

		public RegType GetVar(string name) { 
			if (_vars.ContainsKey(name) == false)
				throw new Exception(U.F("variable {0} not found", name));
			return _vars[name];
		}

		public RegType TryGerVar(string name) { 
			if (_vars.ContainsKey(name) == false)
				return null;
			return _vars[name];
		}
