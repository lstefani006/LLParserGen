			...
			case 0:
				{
					...
					tmp_13_s = new StmtBlock(new StmtIf(((ExprRoot)nt3_s), new StmtBlock(((StmtRoot)nt5_s))));
				}
				break;
			case 1:
				{
					...
					tmp_13_s = new StmtBlock(new StmtIf(((ExprRoot)nt3_s), new StmtBlock(((StmtRoot)nt5_s)), new StmtBlock(nt7_s)));
				}
				break;
			}
