...
namespace LLParserGenTest
{
	public partial class MParser : ParserBase
	{
			...
			case 0:
				{
					...
					var nt6_s = tmp_19(nt1_s, nt2_s, nt3_s, nt4_s, nt5_s, nt6_i);
					stmt_s = nt6_s;
				}
				break;
			case 1:
		...
		StmtRoot tmp_19(IAST nt1_s, IAST nt2_s, IAST nt3_s, IAST nt4_s, IAST nt5_s, IAST tmp_19_i)
		{
			int alt = 0;
			switch (Next.ch)
			{
			...
			case 0:
				{
					...
					tmp_19_s = new StmtBlock(new StmtIf(((TokenAST)nt1_s), ((ExprRoot)nt3_s), new StmtBlock(((StmtRoot)nt5_s))));
				}
				break;
			case 1:
				{
					...
					tmp_19_s = new StmtBlock(new StmtIf(((TokenAST)nt1_s), ((ExprRoot)nt3_s), new StmtBlock(((StmtRoot)nt5_s)), new StmtBlock(nt7_s)));
				}
				break;
			}
		...
		StmtRoot tmp_20(IAST nt1_s, IAST tmp_20_i)
		{
			int alt = 0;
			switch (Next.ch)
			{
			...
			StmtRoot tmp_20_s = default(StmtRoot);
			switch (alt)
			{
			case 0:
				{
					...
					TokenAST nt2_s = Match(';', nt2_i);
					tmp_20_s = new StmtReturn(((TokenAST)nt1_s));;
				}
				break;
			case 1:
				{
					...
					TokenAST nt3_s = Match(';', nt3_i);
					tmp_20_s = new StmtReturn(((TokenAST)nt1_s), nt2_s);;
				}
				break;
			}
			...
			case 0:
				{
					...
					tmp_21_s = new ExprAss(((ExprRoot)nt1_s), nt2_s, nt3_s);
				}
				break;
			case 1:
				{
			...
			case 1:
				{
					...
					nt3_i = new ExprBinLogical(((ExprRoot)tmp_5_i), nt1_s, nt2_s); 
			...
			case 1:
				{
					...
					nt3_i = new ExprBinGen(((ExprRoot)tmp_7_i), nt1_s, nt2_s); 
			...
			case 1:
				{
					...
					nt3_i = new ExprBinCompare(((ExprRoot)tmp_10_i), nt1_s, nt2_s); 
			...
			case 1:
				{
					...
					nt3_i = new ExprBinGen(((ExprRoot)tmp_12_i), nt1_s, nt2_s); 
			...
			case 1:
				{
					...
					TokenAST nt1_s = Match('.', nt1_i);
					TokenAST nt2_s = Match(ID, nt2_i);
					nt3_i = new ExprDot(((ExprRoot)tmp_15_i), nt2_s); 
			...
			case 2:
				{
					...
					TokenAST nt3_s = Match(')', nt3_i);
					nt4_i = new ExprFun(((ExprRoot)tmp_15_i), nt1_s, nt2_s); 
					var nt4_s = tmp_15(nt4_i);
					tmp_15_s = nt4_s; 
				}
				break;
		...
		TypeSimple tmp_18(IAST tmp_18_i)
		{
			int alt = 0;
			switch (Next.ch)
			{
			...
			TypeSimple tmp_18_s = default(TypeSimple);
			switch (alt)
			{
			case 0:
				{
			...
			case 1:
				{
					...
					TokenAST nt1_s = Match('.', nt1_i);
					TokenAST nt2_s = Match(ID, nt2_i);
					nt3_i = ((TypeSimple)tmp_18_i).Add(nt2_s); 
